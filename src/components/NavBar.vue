    ...
    <nav class="container px-6 py-4 mx-auto lg:flex lg:justify-between lg:items-center" >
        <div class="flex items-center text-2xl font-bold dark:text-white flex justify-between">
            <a href="#" class="flex my-auto gap-2">
                <img class="w-auto h-8 sm:h-10 my-auto" src="../assets/sundarbans2.png" alt="">
                Sundarbans 
            </a>
            <!-- Mobile menu button -->
            ...
            <div :class="{ 'block': open, 'hidden': !open }" class=" lg:flex lg:items-center">
                <div class=" container flex flex-col space-y-4  lg:mt-0 lg:flex-row lg:-px-8 lg:space-y-0">
                    ...
                    <router-link to="/gallery" class="text-gray-700 transition-colors duration-300 transform lg:mx-8 dark:text-gray-200 dark:hover:text-blue-400 hover:text-blue-500">Gallery</router-link>
                    <router-link to="/council" class="text-gray-700 transition-colors duration-300 transform lg:mx-8 dark:text-gray-200 dark:hover:text-blue-400 hover:text-blue-500">Council</router-link>
                </div>
            </div>
        </div>
          <a href="#"
                ...
                </div><span class="w-5/6 px-1 py-2 font-bold text-center">Sign In</span>
          </a>
    </nav>
</div>
</template>

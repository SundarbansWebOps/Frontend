        ...
        <div class="flex flex-wrap -m-4">
          <div class="container px-5 py-10 mx-auto">
            <div class="flex flex-wrap -m-4" id="adminsContainer">
              <div v-for="admin in admins" :key="admin.name" class="p-4 mx-auto md:w-1/4">
                <div class="w-full overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
                  <img class="object-cover w-full h-56" :src="admin.image_url" alt="avatar" />
                  <div class="py-5 text-center">
                    <a href="#" class="block text-xl font-bold text-gray-800 dark:text-white" tabindex="0" role="link">{{
                      admin.name }}</a>
      ...
      <div class="container px-6 py-10 mx-auto">
        ...
        <div class="">
          <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-4" id="adminsContainer">
            <div v-for="group_leaders in group_leaders" :key="group_leaders.name"
              ...
              <img class="object-cover w-full h-56" :src="group_leaders.image_url" alt="avatar" />
    ...
    <section class="bg-white dark:bg-black">
      <div class="container px-6 py-10 mx-auto">
        ...
        <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-4">
          <div v-for="webops in webops" :key="webops.name"
            ...
            <img class="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300" :src="webops.image_url" alt="avatar" />
      ...
      <div class="container px-6 py-10 mx-auto">
        ...
        <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-4">
          <div v-for="designer in graphics" :key="designer.name"
            class="flex flex-col items-center p-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:border-gray-700 dark:hover:border-transparent">
            <img class="object-cover w-32 h-32 rounded-full ring-4 ring-gray-300" :src="designer.image_url" alt="avatar" />

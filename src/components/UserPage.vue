    ...
    <div class="flex w-full max-w-sm mx-auto overflow-hidden bg-white dark:bg-black  lg:max-w-4xl">
        ...
        <div class="w-full px-6 py-8 md:px-8 lg:w-1/2">
            <div class="flex justify-center mx-auto">
                <img v-if="userDetails" :src="userDetails.picture" class="w-32 rounded-full" alt="{{ userDetails.name }}'s Avatar" />
            </div>

            <p class="mt-3 text-xl text-center text-gray-600 dark:text-gray-200" v-if="userDetails">
                {{ userDetails.name }}
            </p>
            ...
            <div class="flex items-center justify-center mt-4 dark:text-gray-200">
                ...
                <span class="px-2 py-3 font-bold text-center" v-if="userDetails">{{ userDetails.email }}</span>
            </div>
            ...
            <div class="flex items-center justify-center dark:text-gray-200">
                ...
                <span class="px-2 pb-3 font-bold text-center">Mobile Number</span>
            </div>
            ...
            <div class="mt-4">
                <label class="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200"
                    for="LoggingEmailAddress">New Name</label>
            ...
            <div class="mt-4">
                <div class="flex justify-between">
                    <label class="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200"
                        for="loggingPassword">Phone</label>
                </div>

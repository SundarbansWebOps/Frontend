<template>
    <NavBar></NavBar>
    <div class=" dark:bg-black" v-if="userDetails">
        ...
        <div class="flex w-full max-w-sm mx-auto overflow-hidden bg-white dark:bg-black  lg:max-w-4xl">
            ...
            <div class="w-full px-6 py-8 md:px-8 lg:w-1/2">
                ...
                <div class="flex items-center justify-center dark:text-gray-200">
                    ...
                    <span class="px-2 pb-3 font-bold text-center"> Group Number : {{ this.GroupId }}</span>
                </div>
                ...
                <div class="mt-6" v-if="GroupUrl && GroupUrl.length > 0">
    ...
    <div class=" dark:bg-black" v-else>

<template>
  ...
  <div class="dark:bg-black dark:text-white">
    <div class="complaint-details bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md mx-auto w-3/4">
      <h1 class="text-2xl font-semibold mb-4 dark:text-gray-100">
        Complaint Details
      </h1>
      <div class="mb-4">
      ...
      <div class="mb-4">
        ...
        <p class="text-black dark:text-gray-100">
          {{ complaint.gdrive_url || "Not Provided" }}
        </p>
      </div>
      <div class="mb-4">
      ...
      >
        ...
        <button
          type="submit"
          class="mb-4 view-btn border border-gray-500 dark:border-gray-300 py-1 px-3 rounded"
        >
          Send
          Message
        </button>

                  ...
                  >
                    ...
                    <div class="py-5 text-center">
                      <a
                        ...
                        role="link"
                      >
                      <a :href="'https://ds.study.iitm.ac.in/student/' + admins[0].email">{{ admins[0].name }}</a>
                  ...
                  >
                    ...
                    <div class="py-5 text-center">
                      <a
                        ...
                        role="link"
                      >
                      <a :href="'https://ds.study.iitm.ac.in/student/' + admins[1].email">{{ admins[1].name }}</a>
        ...
        <div class="container px-6 py-10 mx-auto">
          ...
          >
            ...
            >
              ...
              >
              <a :href="'https://ds.study.iitm.ac.in/student/' + wops.email">{{ wops.name }}</a>
              </h1>
            </div>
          </div>
        </div>
          ...
          >
            ...
            >
              ...
              <h1
                class="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-white group-hover:text-white"
              >
              <a :href="'https://ds.study.iitm.ac.in/student/' + designer.email">{{ designer.name }}</a>
              </h1>
            </div>
          </div>
        </div>
          ...
          >
            ...
            >
              ...
              <h1
                class="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-white group-hover:text-white"
              >
              <a :href="'https://ds.study.iitm.ac.in/student/' + pr.email">{{ pr.name }}</a>
              </h1>
            </div>
          </div>
        </div>

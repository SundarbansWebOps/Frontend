...
<div class=" dark:bg-black">
        ...
        <form>
            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                <div>
                    ...
                    <input id="username" type="text" v-model="userDetails.given_name" readonly
                ...
                <div>
                    ...
                    <input id="emailAddress" type="email" v-model="userDetails.email" readonly
                        class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-black dark:text-gray-300 dark:border-gray-600 focus:border-yellow-500 dark:focus:border-yellow-500 focus:outline-none ">
                </div>
                ...
                <div>
                    ...
                    <input id="passwordConfirmation" type="text" required
                        class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-black dark:text-gray-300 dark:border-gray-600 focus:border-yellow-500 dark:focus:border-yellow-500 focus:outline-none ">
                </div>
                <div>
    ...
    <!-- login with google -->
    <div
        class="flex w-full max-w-sm mx-auto overflow-hidden py-10 rounded-lg  dark:bg-black lg:max-w-4xl dark:bg-black" v-else>
